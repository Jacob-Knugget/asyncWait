    ...
    class Program
    {
        ...
        {   
            try
            {
                ...
                Shower shower = await TakeAShower(cancellationTokenSource.Token); */
        ...
        /* private static async Task < Shower > TakeAShower(CancellationToken token)
        {
            if ( token.IsCancellationRequested ) {
                throw new TaskCanceledException("A task has been cancelled and an exception thrown");
            }
